<?php
    class ReportePdf extends Controllers{
        ...
        public function reportePdf ($params){
            $data['page_id'] = 'p_listaRep';
            $data['page_title'] = '.:Reporte:.';
            $data['page_tag'] = 'Reporte pdf';
            $data['page_name'] = 'Reporte pdf';
            $this->views->getView($this, 'reportePdf', $data);
        }
