...
document.addEventListener('DOMContentLoaded', function(){
    ...
    formRegistro.onsubmit = function(e) {
        ...
        var ajaxUrl = base_url+'primero/setRegistro';
        ...
        request.onreadystatechange = function(){
            if(request.readyState == 4 && request.status == 200){
                ...
                if(objData.status){
                    ...
                    setTimeout(location.href='usuarios',3000);
                }
                else{
                    Swal.fire({
                        width: '35%',
...
function fntUnidades(){
    var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    var ajaxUrl = base_url+'primero/getSelectUnidades';
...
function fntCargos(){
    var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    var ajaxUrl = base_url+'primero/getSelectCargos';
    request.open('GET', ajaxUrl, true);
    request.send();
...
function fntRoles(){
    var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    var ajaxUrl = base_url+'primero/getSelectRoles';
    request.open('GET', ajaxUrl, true);
    request.send();
...
function fntTitulos(){
    var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    var ajaxUrl = base_url+'primero/getSelectTitulos';
    request.open('GET', ajaxUrl, true);
    request.send();
